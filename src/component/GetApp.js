...
function GetApp() {
  ...
  return (
    <Zoom>{/*Using Zoom Effect*/}
      <div id='GetApp' className='z-0 flex h-full  p-4 md:p-[4rem] mr-auto ml-auto'>
        ...
        <div className='grid max-w-screen-xl px-4 py-8 mx-auto place-content-center lg:gap-8 xl:gap-0 lg:py-16 md:grid-cols-12 '>
          ...
          <div className='  md:hidden md:col-span-5   gap-1 md:mt-[2rem] lg:mt-0'>
            <img src="nfts/app.png" alt="" className=' w-[15rem] h-[15rem] ml-auto mr-auto md:ml-0 md:mr-0' />
          </div>


          <div className='mr-auto place-self-center md:col-span-7 
          lg:w-[32rem]'>
            <h3 className='font-bold w-fit underline1 md:font-bold'> Get App</h3>
            ...
            <p className=' md:text-[23px] lg:text-[25px]  w-full  lg:mt-6 
              mb-4 text-gray-400 lg:text-gray-200  mx-auto mt-2  text-left'>Use our built-in analytics dashboard to pull valuable insights and monitor the value of
