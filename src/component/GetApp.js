    ...
    <Zoom>{/*Using Zoom Effect*/}
      <div id='GetApp' className='z-0 flex h-full p-4 '>
        ...
        <div className='grid max-w-screen-xl px-4 py-8 mx-auto place-content-center lg:gap-8 xl:gap-0 lg:py-16 md:grid-cols-12 '>
            <h3 className='font-bold w-fit underline1 md:font-bold md:col-span-12'>GET OUR APP</h3>
            
            <div className='  md:hidden md:col-span-5   gap-1 md:mt-[2rem] lg:mt-0'>
            <img src="nfts/GetApp.png" alt="" className=' w-[15rem] h-[15rem] ' />
          </div>
          ...
          <div className=' hidden md:visible md:col-span-5 md:flex w-fit h-fit  gap-1 md:mt-[0.5rem] lg:ml-[4rem] lg:mt-0'>
            <img src="nfts/GetApp.png" alt="" className='md:w-[18rem] md:h-[18rem] lg:w-[23rem] lg:h-[23rem] ' />
          </div>
        </div>
