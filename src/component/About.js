      ...
      lg:pb-[90px]
        text-white dark:bg-dark">
          <div className="container mx-auto ">
            <div className="flex flex-wrap items-center justify-center p-8 -mx-4">
                  ...
                  <div className="w-full px-3 sm:px-4 xl:w-1/2">
                    <div className="py-3 sm:py-1">
                      <img
                        ...
                        alt=""
                        className=" w-full lg:w-[16rem] lg:h-[16rem] rounded-3xl"
                      />
                    </div>
                  ...
                  <div className="w-full px-3 sm:px-4 xl:w-1/2">
                    <div className="relative my-4 ">
                      <img
                        ...
                        alt=""
                        className="w-full lg:w-[16rem] lg:h-[22rem] rounded-3xl"
                      />
              ...
              <div className="w-full px-4 lg:w-1/2 xl:w-5/12 ">
                <div className="mt-10 lg:mt-0 lg:ml-4">
                 ...
                 items-center dark:focus:ring-gray-500 
                  p-2
     border-[#9AD6D6] border-2 lg:text-[16px] md:text-md
